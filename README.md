...
I did not code all of it, it was first a trend on tiktok and a found the source code on GitHub, I enhanced it a lot, to make it user friendly. The "original" code can be found here :
https://github.com/YoBoiMarvs/BlueHeart but i'm not sure it's his own code either, I've seen the exact same code in other repositery and video, the code altough is not really optimized
and seems 99% vibecoded (generated by AI) without any review ! 
